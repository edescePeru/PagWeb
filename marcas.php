...
<html lang="en">
	...
	<body class="no-skin">
								...
								<div class="row">
									<div class="col-xs-12">
										...
										<div class="table-header">
											Resultados de "Las últimas Marcas registradas"
										</div>
											...
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													...
													<tr>
														...
														<td data-subcategoria=<?= $fila['3'] ?> data-categoria=<?= $fila['4'] ?>>
															<?= $fila['2'] ?>
														</td>
		...
		<!-- Modals-->
		<div id="modal-marca" class="modal fade" tabindex="-1">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
						<h3 class="smaller lighter blue no-margin"><div id="proceso" class="proceso">Registrar</div> Marca</h3>
					</div>
					<form class="form-horizontal" role="form" id="form-marca">
						<div class="modal-body">
							...
							<div class="form-group">
								...
								<div class="col-sm-9 ">
									<select class="col-sm-9 form-control" id="subcategoria" name="subcategoria">
										<option selected="selected" class="holder" value="0">Seleccionar sub-categoria</option>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" id="marca" name="marca" placeholder="Marca" class="col-xs-10 col-sm-10" />
								</div>
							</div>
...
<![endif]-->
		...
		<script src="misJs/marca.js"></script>
	</body>
</html>

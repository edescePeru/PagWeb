...
function incrementQuantity () {
	...
	var befQuant = parseInt(beforeQuantity) + 1;

	/*console.log('antes'+ beforeQuantity);
	console.log('stock'+ stock);
	console.log('befQuant'+ befQuant);*/
	...
	if ( befQuant <= stock) {
		...
		$.ajax({
			...
			if(response.error) {
				...
				$('[data-cantidad='+producto+']').html(updateQuantity);
		...
		console.log("suficiente...llego al limite");
	};
